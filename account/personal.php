...
?>
        ...
        <div class="page-title relative">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="title">Персональный раздел</h3>
                            <ul class="breadcrumb">
        ...
        <section class="flat-spacing">
				...
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./personal.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/ac.png" alt="">						</span>
					...
					<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./account_order_detail.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/onl.png" alt="">						</span>
						<h2 class="sale-personal-section-index-block-name">
							Текущие заказы						</h2>
					</a>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./account.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/id.png" alt="">							</span>
						<h2 class="sale-personal-section-index-block-name">
							Личные данные						</h2>
					</a>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./account_orders.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/his.png" alt="">						</span>
						<h2 class="sale-personal-section-index-block-name">
							История заказов						</h2>
					</a>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./profile_list.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/del.png" alt="">							</span>
						<h2 class="sale-personal-section-index-block-name">
							Профили заказов						</h2>
					</a>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./price_types.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/mon.png" alt="">					</span>
						<h2 class="sale-personal-section-index-block-name">
							Прайсы и типы цен					</h2>
					</a>
				</div>
			</div>
						<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="./subscriptions.php">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/suub.png" alt="">						</span>
						<h2 class="sale-personal-section-index-block-name">
							Подписки						</h2>
					</a>
				</div>
				...
				<div class="sale-personal-section-index-block bx-green">
					<a class="sale-personal-section-index-block-link" href="/contacts/">
						<span class="sale-personal-section-index-block-ico">
							<img src="/images/icon/cont.png" alt="">						</span>
						<h2 class="sale-personal-section-index-block-name">
							Контакты						</h2>
					</a>
				</div>
                            ...
                            </div><div class="row delivery_tabs delivery_adres">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="delivery_main_panel">
                                        <p class="sale_lbl_top">Уведомления</p>
                                        
                                        <div class="personal_data_wrp">
                                            <div class="pers_item">
                                                <span>Город:</span>
                                                <p>Нальчик</p>
                                                <a href="" class="edit_pers address_control" data-toggle="modal" data-target="#edit_city"><img src="/img/address_control1.svg" alt=""></a>
                                            </div>
                                        </div>
                                        
                                        <div class="notification_checker">
                                            <p>Получать письма о товарах недели, скидках и акциях</p>
  ...
  <span class="slider round"></span>
                                        ...
                                        <button class="tf-btn btn-onsurface">Сохранить изменения</button>
                                    </div>
                                </div>
