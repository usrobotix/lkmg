...
$APPLICATION->SetTitle("Изменить данные - физ лицо");
?>
        ...
        <div class="page-title relative">
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="title">Изменить данные - физ лицо</h3>
                            <ul class="breadcrumb">
                                <li><a href="#">Главное</a></li>
                                <li>Изменить данные - физ лицо</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="my-account-content">
                            ...
                            <form action="#" class="form-account-details form-has-password">
                                    <div class="account-info">
                                        <h5 class="title">Профиль №1</h5>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <p style="
    font-size: 20px;
">Тип плательщика: Физическое лицо</p>
                                            </fieldset>                                            
                                        </div>
                                    ...
                                    <div class="cols mb_20">
                                            <fieldset class="">
                                                <input class="" type="text" placeholder="Профиль 1" name="text" tabindex="2" value="" aria-required="true" required="">
                                            </fieldset>                                            
                                        </div></div>
                                    <div class="account-info">
                                        <h5 class="title">Личные данные</h5>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <input class="" type="text" placeholder="Иванов И" name="text" tabindex="2" value="" aria-required="true" required="">
                                            </fieldset>
                                    ...
                                    <div class="account-info">
                                        <h5 class="title">Данные для доставки</h5>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <input class="" type="text" placeholder="360000000" name="text" tabindex="2" value="" aria-required="true" >
                                            </fieldset>
                                            
                                        </div>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <input class="" type="email" placeholder="Республика Мордовия" name="email" tabindex="2" value="" aria-required="true" >
                                            </fieldset>
                                        
                                        </div>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <input class="" type="email" placeholder="г. Саранск, ул. Меньшикова, 15" name="email" tabindex="2" value="" aria-required="true" >
                                            </fieldset>
                                      
                                        </div>
                                        <div class="cols mb_20">
                                            <fieldset class="">
                                                <textarea class="" type="email" placeholder="Республика Мордовия, г. Саранск, ул. Меньшикова, 15" name="email" tabindex="2" value="" aria-required="true" ></textarea>
                                            </fieldset>
...
">
                                    ...
                                    <button class="tf-btn btn-onsurface" type="submit">Применить</button>
<a href="#">Отмена</a>
</div>
                                </form>
                            </div>
